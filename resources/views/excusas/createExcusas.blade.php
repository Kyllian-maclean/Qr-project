...
<a href="{{ route('excusas.aprendiz.index') }}" class="btn btn-success">Retroceder</a>
        ...
        <div class="content mt-5">
            <form method="POST" action="{{ route('excusas.store.index') }}" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    <label for="instructor_id" class="col-md-4 col-form-label text-md-right">ID del Instructor</label>
                    <div class="col-md-6">
                        <select id="instructor_id" class="form-control2" name="instructor_id" required>
                ...
                <div class="form-group row mb-0">
                    <div class="col-md-6 offset-md-4">
                        <button type="submit" name="capturar" value="ok" class="btn btn-success">
                            {{ __('Guardar Excusa') }}
                        </button>
                    </div>
                </div>
