      ...
      <form action="{{ route('users.update', ['user' => $user] ,['userRoleIds'=>$userRoleIds]) }}" method="POST">
          ...
          <div class="info-usuario">
              ...
              <div class="coolinput ">
                  ...
                  <input disabled type="" name="text" id="email" class="input" step="0.01" value="{{$user->email}}" required>
              </div>
            ...
            <div class="form-group mb-3">
              ...
              <div class="form-check">
                ...
                @endif
                <label class="text" for="instructor">Instructor</label>
              </div>
              <div class="form-check">
                ...
                @endif
                <label class="text" for="admin">Administrador</label>
              </div>
            </div>
          </div>   
      </form>
      ...
      <div class="info-usuario">
        <form action="{{ route('updatesPassword') }}" method="POST">
          ...
          <div class="cambio-contra">
            ...
            <button class="cambiar btn btn-danger mt-4 mb-5" type="submit">Cambiar Contraseña</button>      
          </div>
        </form>   
      </div>
    </div>
